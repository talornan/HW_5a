...
void MagicalContainer::addElement(int element)
{
    ...
    if (in.second)
    {
        ...
        elementsAsc.insert(upper_bound(elementsAsc.begin(), elementsAsc.end(), address), address);

        if (isPrime(element))
        {
            elementsP.insert(upper_bound(elementsP.begin(), elementsP.end(), address), address);
        }
...
void MagicalContainer::removeElement(int element)
{
    ...
    if (it == elements.end())
    {
        throw invalid_argument("Error: element not found");
    }
    ...
    auto it_sidecross = find(elementsSide.begin(), elementsSide.end(), address);
    if (it_sidecross != elementsSide.end())
    {
        elementsSide.erase(it_sidecross);
    }
}
